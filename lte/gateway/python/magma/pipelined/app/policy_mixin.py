...
class PolicyMixin(metaclass=ABCMeta):
    ...
    def activate_rules(self, imsi, msisdn: bytes, uplink_tunnel: int, ip_addr, apn_ambr, policies, ng_session_id=0):
        """
    ...
    def _install_flow_for_rule(self, imsi, msisdn: bytes, uplink_tunnel: int,
                               ip_addr, apn_ambr, rule, version, ng_session_id=0):
        """
